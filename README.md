...
```console
$ docker run -d --net=host -v /home/steam/csgo-dedicated2/ --name=csgo-dedicated2 -e SRCDS_PORT=27016 -e SRCDS_TV_PORT=27021 -e SRCDS_TOKEN={YOURTOKEN} cm2network/csgo
```
